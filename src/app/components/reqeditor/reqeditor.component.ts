...
@Component({
  selector: 'app-reqeditor',
  templateUrl: './reqeditor.component.html',
  styleUrls: ['./reqeditor.component.css']
})
export class ReqeditorComponent implements OnInit, OnDestroy {
