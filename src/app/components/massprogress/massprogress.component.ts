...
@Component({
  selector: 'app-massprogress',
  templateUrl: './massprogress.component.html',
  styleUrls: ['./massprogress.component.css']
})
export class MassprogressComponent implements OnInit, OnDestroy {
